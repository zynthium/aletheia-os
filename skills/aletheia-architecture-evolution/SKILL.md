...
description: Guide complex architecture iteration in AletheiaOS repositories. Use when changing module boundaries, contracts, dependency direction, project skeleton nodes, ADR/RFC records, migration plans, or architecture drift checks.
---
...
4. Define migration and rollback boundaries.

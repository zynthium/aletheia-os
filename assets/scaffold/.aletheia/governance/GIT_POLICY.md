...
The default checkpoint runtime stages AletheiaOS state paths only. To stage the whole worktree, the operator must explicitly pass `--include-worktree`; secret-like path names still block checkpointing.

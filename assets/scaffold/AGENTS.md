...
The repository is the durable project memory. Chat history is not durable memory.
...
For non-trivial completion, update affected `.aletheia/` records, run validation, and create or explicitly defer a checkpoint.

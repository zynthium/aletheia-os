...
- A meaningful experiment should produce or update an evidence record in `aletheia_os/evidence/`.
...
1. Update `aletheia_os/evidence/`.
2. Update `aletheia_os/02_ACTIVE_STATE.md` and possibly `aletheia_os/01_SYSTEM_GRAPH.yaml`.

...
REQUIRED = [
    ...
    "skills/aletheia-promote/SKILL.md",
    "assets/scaffold/.aletheia/START_HERE.md",
    "assets/scaffold/.aletheia/CAPABILITY_MAP.md",
    ...
    "assets/scaffold/.aletheia/state/ORPHANS.yaml",
    "assets/scaffold/.aletheia/state/USER_PREFERENCES.md",
    ...
    "assets/scaffold/.aletheia/playbooks/prompt_native_boundaries.md",
    "assets/scaffold/.aletheia/playbooks/tree_governed_truth_growth.md",
    "assets/scaffold/.aletheia/playbooks/skeleton_review.md",
    "assets/scaffold/.aletheia/bin/help.py",
    "assets/scaffold/.aletheia/bin/orient.py",
    "assets/scaffold/.aletheia/bin/context_pack.py",
    "assets/scaffold/.aletheia/bin/system_context.py",
    "assets/scaffold/.aletheia/bin/preflight.py",

...
The AI assistant may propose, implement, and critique. The project owner owns final changes to mission, priority order, and root assumptions unless explicitly delegated.
